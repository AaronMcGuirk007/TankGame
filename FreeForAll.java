...
public class FreeForAll extends SpriteController implements KeyListener {
	...
	// Terrain background
	private Image background = Toolkit.getDefaultToolkit().getImage("gifs/Sledding.gif");
